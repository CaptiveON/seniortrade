...
```bash
python -m src.cli ui                            # web cockpit at 127.0.0.1:8484 — Universe Studio (pick WHAT to scan:
                                                #   movers / new listings / mcap band / your own list) + the FULL
                                                #   SPECTRUM board: every candidate tiered alpha→loser, each with a
                                                #   Consequence Card (20-trade MC in R and your $) — never a void
